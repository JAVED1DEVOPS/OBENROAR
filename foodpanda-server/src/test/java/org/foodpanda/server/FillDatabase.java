...
import org.foodpanda.common.Constants;
...
public class FillDatabase extends AbstractPdoTest {
  ...
  public void addUsersAndGroups() {
    ...
    user = user.persist();
    user.updatePasswordHash(foodpandaHelper.hash(new char[] {'g', 'o', 'n', 'z', 'o'}));
    ...
    user.getUserGroups().add(group);
    user = user.persist();
    user.updatePasswordHash(foodpandaHelper.hash(new char[] {'p', 'i', 'g', 'g', 'y'}));
    ...
    user.setSystemPreferencesOnly(true);
    user = user.persist();
    user.updatePasswordHash(foodpandaHelper.hash(new char[] {'d', 'a', 'e', 'm', 'o', 'n'}));
