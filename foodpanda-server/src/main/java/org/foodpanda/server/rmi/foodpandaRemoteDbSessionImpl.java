...
import org.foodpanda.common.foodpandaHelper;
import org.foodpanda.common.foodpandaSessionInfo;
import org.foodpanda.pdo.MessageType;
import org.foodpanda.pdo.md.User;
import org.foodpanda.pdo.td.Message;
import org.foodpanda.persist.rmi.foodpandaRemoteDbSession;
import org.foodpanda.server.ServerBundle;
 ...
 */
public class foodpandaRemoteDbSessionImpl extends RemoteDbSessionImpl implements foodpandaRemoteDbSession {
   ...
   */
  public foodpandaRemoteDbSessionImpl(RemoteDbConnectionImpl con, SessionInfo clientInfo, SessionInfo serverInfo) {
    super(con, clientInfo, serverInfo);
  }

  @Override
  public void verifySessionInfo(SessionInfo sessionInfo) {
    String passwordHash = foodpandaHelper.hash(sessionInfo.getPassword());
  ...
  protected void closeDb(boolean cleanup) {
    ...
    if (session != null && !session.isRemote()) {
      try {
        foodpandaSessionInfo sessionInfo = (foodpandaSessionInfo) getClientSessionInfo();
