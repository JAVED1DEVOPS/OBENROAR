...
package org.foodpanda.gui.main;

import org.foodpanda.common.foodpandaDomainContext;
import org.foodpanda.gui.foodpandaImageProvider;
import org.foodpanda.gui.about.AboutView;
import org.foodpanda.gui.password.ChangePasswordView;
import org.foodpanda.gui.prefs.PreferencesDialog;
...
public class MainController extends AbstractFxController implements DomainContextProvider {
  ...
  @Override
  public foodpandaDomainContext getDomainContext() {
    return (foodpandaDomainContext) AbstractApplication.getRunningApplication().getDomainContext();
  }

  @FXML
  public void initialize() {

    ImageView centerImage = Fx.createImageView(foodpandaImageProvider.REALM, "tentackle");
    ...
    editUserItem.setGraphic(Fx.createImageView(foodpandaImageProvider.REALM, "user"));
    editUserItem.setOnAction(e -> edit(User.class));

    editUserGroupItem.setGraphic(Fx.createImageView(foodpandaImageProvider.REALM, "usergroup"));
    editUserGroupItem.setOnAction(e -> edit(UserGroup.class));

    searchUserItem.setGraphic(Fx.createImageView(foodpandaImageProvider.REALM, "user"));
    searchUserItem.setOnAction(e -> search(User.class));

    searchUserGroupItem.setGraphic(Fx.createImageView(foodpandaImageProvider.REALM, "usergroup"));
    searchUserGroupItem.setOnAction(e -> search(UserGroup.class));

    searchMessageItem.setGraphic(Fx.createImageView(foodpandaImageProvider.REALM, "message"));
