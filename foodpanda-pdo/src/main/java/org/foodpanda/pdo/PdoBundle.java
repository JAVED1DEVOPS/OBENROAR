...
/**
 * Bundle for translations of the PDO module.
 */
@Bundle
public class PdoBundle {
  ...
  public static ResourceBundle getBundle() {
    return BundleFactory.getBundle(PdoBundle.class.getName(), LocaleProvider.getInstance().getLocale());
  }
